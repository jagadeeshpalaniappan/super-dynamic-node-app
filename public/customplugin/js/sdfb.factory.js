angular.module('superDynamicFormBuilder').constant('deepMerge', (function () {
...
/*
   ...
   * meta data.
   */
angular.module('superDynamicFormBuilder').factory('getOIMConfig',["deepMerge", function (deepMerge) {
...
angular.module('superDynamicFormBuilder').factory('commonService', function () {
